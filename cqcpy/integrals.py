...
def get_chem(mol,o1,o2,o3,o4):
    ...
    n3 = o3.shape[1]
    n4 = o4.shape[1]
    I = ao2mo.general(mol,(o1,o2,o3,o4),compact=False).reshape(n1,n2,n3,n4)
    return I
...
def get_chem_anti(mol,o1,o2,o3,o4):
    ...
    n3 = o3.shape[1]
    n4 = o4.shape[1]
    Id = ao2mo.general(mol,(o1,o2,o3,o4),compact=False).reshape(n1,n2,n3,n4)
    Ix = ao2mo.general(mol,(o1,o4,o3,o2),compact=False).reshape(n1,n4,n3,n2)
...
def get_phys(mol,o1,o2,o3,o4):
    ...
    n3 = o3.shape[1]
    n4 = o4.shape[1]
    I = ao2mo.general(mol,(o1,o3,o2,o4),compact=False).reshape(n1,n3,n2,n4)
...
def get_phys_anti(mol,o1,o2,o3,o4):
    ...
    n3 = o3.shape[1]
    n4 = o4.shape[1]
    Id = ao2mo.general(mol,(o1,o3,o2,o4),compact=False).reshape(n1,n3,n2,n4)
    Ix = ao2mo.general(mol,(o1,o4,o2,o3),compact=False).reshape(n1,n4,n2,n3)
...
def get_chem_antiu(mol,o1,o2,o3,o4,p1,p2,p3,p4,anti=True):
    ...
    Id = ao2mo.general(mol,(q1,q2,q3,q4),compact=False).reshape(
        n1+m1,n2+m2,n3+m3,n4+m4)
    Ix = ao2mo.general(mol,(q1,q4,q3,q2),compact=False).reshape(
...
def get_chem_antiu_all(mol,oa,ob,anti=True):
    ...
    Id = ao2mo.general(mol,(ofull,ofull,ofull,ofull),
...
class eri_blocks(object):
    ...
    def __init__(self, mf, code=0):
        ...
        if len(mo_occ.shape) == 1:
            ...
            self._build_integrals(mf,o,o,v,v)
            ...
            self._build_integrals(mf,oa,ob,va,vb)

    def _build_integrals(self, mf, oa, ob, va, vb):
        if self.has_vvvv:

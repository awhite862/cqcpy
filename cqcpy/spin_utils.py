...
# Print all unrestricted blocks of general T2 amps:
...
def int_to_spatial(I, noa, nob, nva, nvb):
    ...
    Iabab = two_e_blocks_full(
        ...
        voov=voov, ovov=ovov, oovv=oovv, vooo=vooo,
        ovoo=ovoo, oovo=oovo, ooov=ooov, oooo=oooo)
